 ...
 * - [Золотое сечение](https://ru.wikipedia.org/wiki/%D0%97%D0%BE%D0%BB%D0%BE%D1%82%D0%BE%D0%B5_%D1%81%D0%B5%D1%87%D0%B5%D0%BD%D0%B8%D0%B5)
...
fun GoldenRatioLayout(
    ...
    Layout(
        ...
        var newConstraints = Constraints(
            0,
            (minOf(constraints.maxWidth, constraints.maxHeight) * ratio.first).toInt(),
            0,
            (minOf(constraints.maxHeight, constraints.maxWidth) * ratio.first).toInt()
        )
